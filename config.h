...
#define PACKAGE_BUGREPORT "https://bugs.freedesktop.org/enter_bug.cgi?product=Wayland&component=wayland&version=1.9.90"

/* Define to the full name of this package. */
#define PACKAGE_NAME "wayland"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "wayland 1.9.90"
